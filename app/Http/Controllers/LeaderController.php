...
class LeaderController extends Controller
{
    ...
    {
        return view('leaders.list')->with('leader', Leader::all())->with('years', Year::all())->with('position', Position::all());
    }
    ...
    public function trashed()
    {
      ...
      return view('leaders.list')->with('leader', $trashed)->with('position', Position::all());
    }
